<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_menu.aspx.cs" Inherits="waiterPlatform.UI.add_menu" %>
                        ...
                        <div class="block">
                            ...
                            <div class="data-fluid">
                                ...
                                <div class="row-form">
                                    ...
                                    <div class="span10">
                                        <input name ="name" type="text" class="validate[required,maxSize[8]]"/>
                                ...
                                <div class="row-form">
                                    ...
                                    <div class="span5">
                                        <input name="price" type="text" class="validate[required,custom[integer],min[0],max[120]]"/>
